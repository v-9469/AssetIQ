...
public class MavenWrapperDownloader {
    ...
    /**
     * Name of the property which should contain the final URL from which to download the maven-wrapper.jar.
     */
    ...
    public static void main(String args[]) {
        ...
        // If the maven-wrapper.properties exists, read it and check if it has a custom
        // wrapperUrl.
        ...
        try {
            ...
            System.err.println("- Error downloading maven-wrapper.jar");
            e.printStackTrace();
            System.exit(1);
        }
    }
